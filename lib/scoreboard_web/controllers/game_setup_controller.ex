defmodule ScoreboardWeb.GameSetupController do
  ...
  defp to_game_state(%{"switch_on_scoreboard" => switch} = params, state) do
    params
    |> Map.delete("switch_on_scoreboard")
    |> to_game_state(Map.put(state, :switch_on_scoreboard, switch == "true"))
  end
